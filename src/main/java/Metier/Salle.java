 ...
 * <p>
 * Cette classe définit une salle d'un batiment. Elle comporte des ArrayList de
 * machines.
 * </p>
 *
...
public class Salle extends JLabel {
   // Déclarations des attributs :
    ...
    /**
     * Permet de retirer une machine correspondant à celle passé en paramètre de
     * l'ArrayList'machine'.
     *
    ...
    /**
     * Obtenir toutes les informations sur la salle de manière formaté
     * ci-dessous: *******DEBUT******** Nom: Numéro Etage:
     * ********************************** Nombre de machines: Nombre
     * d'équipement réseaux: Nombre d'ordinateur: Nombre d'équipement protable:
     * *******FIN**********
     *
     * @return Nom, localisation, description du batiment, nombre d'entités dans
     * la salle.
     */
